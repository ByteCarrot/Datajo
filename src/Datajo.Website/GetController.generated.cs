...
namespace ByteCarrot.Datajo.Website.Controllers.Documentation.Get
{
    public partial class GetController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected GetController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public GetController Actions { get { return MVC.Get; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Get";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Get";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_GetController : ByteCarrot.Datajo.Website.Controllers.Documentation.Get.GetController
    {
        public T4MVC_GetController() : base(Dummy.Instance) { }
